...
let
  sources = {
    ...
    "core-js-3.4.7" = {
      ...
      version = "3.4.7";
      src = fetchurl {
        url = "https://registry.npmjs.org/core-js/-/core-js-3.4.7.tgz";
        sha512 = "qaPVGw30J1wQ0GR3GvoPqlGf9GZfKKF4kFC7kiHlcsPTqH3txrs9crCp3ZiMAXuSenhz89Jnl4GZs/67S5VOSg==";
      };
    };
    "core-util-is-1.0.2" = {
      name = "core-util-is";
...
in
{
  ...
  elm-upgrade = nodeEnv.buildNodePackage {
    ...
    version = "0.19.7";
    src = fetchurl {
      url = "https://registry.npmjs.org/elm-upgrade/-/elm-upgrade-0.19.7.tgz";
      sha512 = "/BFMWGJ0SmoFzsYb7QwKUZ7kfdimllVkRO51NokYCj9ehAts5TnuG+GLHsmVCJh1mGL4Qc0D4cgeleEwDgoCAQ==";
    };
    dependencies = [
  ...
  "@elm-tooling/elm-language-server" = nodeEnv.buildNodePackage {
    ...
    version = "1.4.5";
    src = fetchurl {
      url = "https://registry.npmjs.org/@elm-tooling/elm-language-server/-/elm-language-server-1.4.5.tgz";
      sha512 = "L+yyDcVhi/TcYaeGiCac2KDV5zMoorTOmEYDT8zwDGo8l1Z/1pToHd4LRrpbHLaR7svQy3ZOD9KYTH6jAy+BSw==";
    };
    dependencies = [
